...
class Game {
   ...
   */ draw = ()=>{
        ...
        if (this.waveIncomingText) this.displayMessage("Huge Wave Incoming!", (0, _constants.CANVAS_WIDTH) / 3.5, (0, _constants.CANVAS_HEIGHT) / 2, 5000);
    };
    /**
   ...
   *
   */ handleWin = ()=>{
        if (this.player.score >= 1000) this.onGameOver();
    };
    /**
...
class Bullet {
   ...
   */ constructor({ x, y, direction = 1, verticalDirection = false, damage = 5, color, speed = 5 }){
        this.position = {
            x,
            y
        };
